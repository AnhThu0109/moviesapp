...
const PopularAscPage = () => {
  ...
  const getData = async (page=1) => {
    const json = await fetchPageSort(page, "/discover/movie?", "&language=en-US&sort_by=popularity.asc&include_adult=false&include_video=false&page=", "&with_watch_monetization_types=flatrate");   
    if (json) {
      console.log(json);
  ...
  return (
    ...
    <div className="col-sm-4 col-lg-3 my-3 sort ms-3 rounded-4">
      ...
      <DropdownButton title="Sort Results By" className="sortFilm">
        ...
        <Dropdown.Item><Link to="/movies/top/des">Rating Descending</Link></Dropdown.Item>
